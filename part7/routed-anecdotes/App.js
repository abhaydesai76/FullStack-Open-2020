...
//         <link style={padding} to="/createAnecdote"></link>
//       </div>
...
const CreateNew = (props) => {
  ...
  const Reset = (e) =>
  {
    ...
    // content = useResetField('text')
    // author = useResetField('text')
    // info = useResetField('text')
    content.onReset()
    author.onReset()
    info.onReset()
  }
  ...
  return (
    <div>            
        <div>
          ...
          <Link style={padding} to="/createAnecdote">Create</Link>
